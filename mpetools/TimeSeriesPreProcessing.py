...
class PreProcess:
    def __init__(self, island_info, plot_confounders=False, frequency='monthly', overwrite=False):
    ...
    def main(self):
        ...
        list_timeseries = [self.island_info[key]['timeseries'] for key in self.island_info.keys() 
                           ...
                           and (key != 'timeseries_WHO' and key != 'timeseries_WorldBank' and key != 'timeseries_disasters' and key != 'timeseries_climate_indices' and key != 'timeseries_nighttime_light')
        ...
        list_timeseries_socioeconomics = [self.island_info[key]['timeseries'] for key in self.island_info.keys() 
                                          if (('timeseries' in self.island_info[key]) 
                                          and (key == 'timeseries_WHO' or key == 'timeseries_WorldBank' or key == 'timeseries_disasters' or key == 'timeseries_nighttime_light')
                                          and (self.island_info[key]['timeseries'] is not None))]
