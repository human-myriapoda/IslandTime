...
# CoastSat modules
from IslandTime.coastsatmaster.coastsat import SDS_preprocess, SDS_tools, gdal_merge
...
def download_tif(image, polygon, bands, filepath, satname):
    ...
    # for the newer versions of ee
        ...
        download_id = ee.data.getDownloadId({'image': image,
                                             ...
                                             'filePerBand': True,
                                             'name': 'image'})
        response = requests.get(ee.data.makeDownloadUrl(download_id), timeout=100000)  
