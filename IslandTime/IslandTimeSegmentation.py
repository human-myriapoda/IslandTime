...
class Segmentation:
    def __init__(self, island_info, list_sat=['S2', 'L8', 'L9'], generate_unsupervised_classification=False, overwrite=False, save=True, plot_results=False, plot_all=False, find_polygons=True):
    ...
    def _band_segmentation(self, im, rgb, label, segmented_image, cmap, classes_to_consider=None, plot_results=False, animation=False, verbose=False, find_polygons=True, remove_small_contours=False):
    ...
    def time_series_from_polygons(self, dict_poly, dict_georef, dict_image_epsg, dict_best_polygons):
        ...
        for key in dict_best_polygons.keys():
            ...
            for key_transect, transect in transects_image_crs.items():
                ...
                point_transect = shapely.geometry.Point(transect[1, 0], transect[1, 1])
