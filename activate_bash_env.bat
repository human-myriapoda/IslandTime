...
set CONDAPATH=C:\Users\mp222\AppData\Local\anaconda3\envs
rem Define here the name of the environment
set ENVNAME=IslandTime

rem The following command activates the base environment.
rem call C:\ProgramData\Miniconda3\Scripts\activate.bat C:\ProgramData\Miniconda3
if %ENVNAME%==main (set ENVPATH=%CONDAPATH%) else (set ENVPATH=%CONDAPATH%\envs\%ENVNAME%)
